...
**w!config text_color <hex>** - Change the color of the lines below Welcome"""
        ...
        embed.set_image(url=f"https://cdn.discordapp.com/attachments/727193410762571789/727700017229332551/tutorial.png")
    ...
    async def about(self, ctx):
        ...
        embed.set_author(name="About", icon_url="https://cdn.discordapp.com/avatars/723573933521109083/6ffeb622ab2e1a33ba7c2ab916dca3ad.webp?size=1024")
        ...
        embed.set_footer(text=f"Python {platform.python_version()} | discord.py {discord.__version__} | world#1400")
        await ctx.send(embed=embed)
def setup(bot):
